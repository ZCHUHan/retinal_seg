...
class feature_fuse(nn.Module):
    def __init__(self, in_c, out_c, quan_input = True):
        ...
        self.conv11 = QuanConv(
            in_c, out_c, kernel_size=1, padding=0, bias=False, norm=True, quan_input = quan_input)
        self.conv33 = QuanConv(
            in_c, out_c, kernel_size=3, padding=1, bias=False, norm=True, quan_input = quan_input)
        self.conv33_di = QuanConv(
            in_c, out_c, kernel_size=3, padding=2, bias=False, dilation=2, norm=True, quan_input = quan_input)
...
class FR_UNet_Quan(nn.Module):
    ...
    def forward(self, x):
        ...
        x1_1, x_down1_1 = self.block1_1(qcat1, os_cat1)
        ...
        x2_1, x_up2_1, x_down2_1 = self.block2_1(qcat2, os_cat2)
        ...
        x10, x_down10 = self.block10(qcat3, os_cat3)
        ...
        x20, x_up20, x_down20 = self.block20(qcat4, os_cat4)
        ...
        x30, x_up30 = self.block30(qcat5, os_cat5)
        ...
        x11, x_down11 = self.block11(qcat6, os_cat6)
        ...
        x21, x_up21 = self.block21(qcat7, os_cat7)
        ...
        _, x_up31 = self.block31(qcat8, os_cat8)
        ...
        x12 = self.block12(qcat9, os_cat9)
        ...
        _, x_up22 = self.block22(qcat10, os_cat10)
        ...
        x13 = self.block13(qcat11, os_cat11)    
        
        if self.out_ave == True:
            a, r_a = self.quan_["final1_16bit"](self.final1(x1_1, os_cat3)) # 8, 16
            b, r_b = self.quan_["final1_8bit"](self.final2(x10, os_cat6))        
            ...
            c, r_c = self.quan_["final2_16bit"](self.final3(x11, os_cat9))
            ...
            d, r_d = self.quan_["final3_16bit"](self.final4(x12, os_cat11)) 
