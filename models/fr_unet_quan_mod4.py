...
from quantizer.quant_lsq import QuanConv, QuanResize, QuanRELU, get_global_idx, get_next_global_idx, SymmetricQuantFunction
...
class up(nn.Module):
    ...
    def forward(self, x, scale_x=None, scale_resize=None):
        ...
        x_r = SymmetricQuantFunction.apply(x, 8, scale_resize) * scale_resize
        x_r = self.resize(x_r, scale_factor=2, mode='bilinear')
        x_r = SymmetricQuantFunction.apply(x_r, 8, scale_resize) * scale_resize
